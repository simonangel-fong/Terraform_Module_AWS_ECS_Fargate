...
docker run --rm --name k6_con --net=host -p 5665:5665 -e MAX=1000 -e K6_WEB_DASHBOARD=true -e K6_WEB_DASHBOARD_EXPORT=load.html -e BASE_URL=http://d19tn7iec1lu1l.cloudfront.net -v ./:/app k6 run local_load.js
```
